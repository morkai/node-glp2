 ...
 * @param {function(string, object, boolean): SerialPort} [options.createSerialPort]
...
function Master(options)
{
  ...
  if (options.createSerialPort)
  {
    this.createSerialPort = options.createSerialPort;
  }
...
Master.prototype.open = function()
{
  ...
  this.serialPort = this.createSerialPort(this.comPort, {
    baudRate: 9600,
    parity: 'none',
    dataBits: 8,
    stopBits: 1
 ...
 * @returns {SerialPort}
 */
Master.prototype.createSerialPort = function(comPort, options, autoOpen)
{
  var SerialPort = require('serialport').SerialPort;

  return new SerialPort(comPort, options, autoOpen);
};
...
{
  var firstByte = this.incomingData.readByte(0);

  if (this.incomingData.length === 1)
  {
    if (firstByte === util.CHR.NAK)
    {
      this.incomingData.skip();
